...
api.set(_primId,{"text": node.value.characters, "horizontalAlignment": textAlign, "verticalAlignment" : node.value.style.textAlignVertical, "textBoxSize.x": textBoxSizeX, "textBoxSize.y": textBoxSizeY,  "fontSize": node.value.style.fontSize })
api.set(_primId, {"font":{"font": node.value.style.fontFamily, "style": textWeight, "fontSize": node.value.style.fontSize}})
