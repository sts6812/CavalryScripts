...
api.keyframe(layerObj, stagger * num.onValueChanged(), {"lineSpacing": lineSpacing, "letterSpacing": letterSpacing, "fontSize": fontSize, "generator.cornerRadius" : cornerRadius,"material.materialColor.r": red*255, "material.materialColor.g": green*255, "material.materialColor.b": blue*255, "generator.dimensions.x":xWidth , "generator.dimensions.y":yHeight,"position.x": xPos, "position.y": yPos})
    ...
    api.keyframe(layerObj, (stagger * num.onValueChanged())+ num1.onValueChanged(), {"lineSpacing": lineSpacing2, "letterSpacing": letterSpacing2, "fontSize": fontSize2, "generator.cornerRadius" : cornerRadius2,"material.materialColor.r": red2*255, "material.materialColor.g": green2*255, "material.materialColor.b": blue2*255, "generator.dimensions.x":xWidth2 , "generator.dimensions.y":yHeight2,"position.x": xPos2, "position.y": yPos2})
    api.select([layerObj]);
api.bringToFront();
...
api.keyframe(layerObj2, stagger * num.onValueChanged(), {"lineSpacing": lineSpacing, "letterSpacing": letterSpacing, "fontSize": fontSize, "generator.cornerRadius" : cornerRadius,"material.materialColor.r": red*255, "material.materialColor.g": green*255, "material.materialColor.b": blue*255, "generator.dimensions.x":xWidth , "generator.dimensions.y":yHeight,"position.x": xPos, "position.y": yPos})
      ...
      api.keyframe(layerObj2, (stagger * num.onValueChanged())+ num1.onValueChanged(), {"lineSpacing": lineSpacing2, "letterSpacing": letterSpacing2, "fontSize": fontSize2, "generator.cornerRadius" : cornerRadius2,"material.materialColor.r": red2*255, "material.materialColor.g": green2*255, "material.materialColor.b": blue2*255, "generator.dimensions.x":xWidth2 , "generator.dimensions.y":yHeight2,"position.x": xPos2, "position.y": yPos2})
...
//api.offsetLayerTime(layerObj2, stagger * ((num1.onValueChanged()/2)+5));
    ...
    try{
api.keyframe(layerObj2, stagger * num.onValueChanged(), {"lineSpacing": lineSpacing, "letterSpacing": letterSpacing, "fontSize": fontSize, "generator.cornerRadius" : cornerRadius,"material.materialColor.r": red*255, "material.materialColor.g": green*255, "material.materialColor.b": blue*255, "generator.dimensions.x":xWidth , "generator.dimensions.y":yHeight,"position.x": xPos, "position.y": yPos, "textBoxSize.x": textBoxSizeX2, "textBoxSize.y": textBoxSizeY2})
        
        api.keyframe(layerObj, stagger * num.onValueChanged(), {"textBoxSize.x": textBoxSizeX, "textBoxSize.y": textBoxSizeY})
        
        api.keyframe(layerObj2, (stagger * num.onValueChanged())+ num1.onValueChanged(), {"lineSpacing": lineSpacing2, "letterSpacing": letterSpacing2, "fontSize": fontSize2, "generator.cornerRadius" : cornerRadius2,"material.materialColor.r": red2*255, "material.materialColor.g": green2*255, "material.materialColor.b": blue2*255, "generator.dimensions.x":xWidth2 , "generator.dimensions.y":yHeight2,"position.x": xPos2, "position.y": yPos2, "textBoxSize.x": textBoxSizeX2, "textBoxSize.y": textBoxSizeY2})
        
        api.keyframe(layerObj, (stagger * num.onValueChanged())+ num1.onValueChanged(), {"textBoxSize.x": textBoxSizeX, "textBoxSize.y": textBoxSizeY})
